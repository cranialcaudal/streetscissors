defmodule WebWeb.CoreComponents do
  ...
  def blog_header(assigns) do
    ...
    <header
      ...
      style="display: grid !important; grid-template-columns: 1fr auto 1fr !important; align-items: center !important; width: 100% !important; padding: 1.1rem 3rem !important; background: var(--paper) !important; border-bottom: 1px solid var(--rule-strong) !important; position: sticky !important; top: 0 !important; z-index: 10000 !important; box-sizing: border-box !important; min-height: 84px !important;"
    >
      <div
        class="header-left"
      ...
      <div class="header-center" style="display: flex !important; justify-content: center !important;">
        <a href={~p"/"} class="header-logo-container" style="text-decoration: none !important;">
          <h1
            ...
            aria-label="streetscissors"
            style="color: var(--ink) !important; margin: 0 !important; transform: none !important; white-space: nowrap !important; line-height: 1 !important; display: block !important;"
          >
            <.wordmark />
          </h1>
        </a>
      ...
      >
        ...
        >
          <span class="top-bar-label">Newsletter and Contact</span>
    ...
    <style>
      @media (max-width: 900px) {
        .blog-universal-header { grid-template-columns: 1fr 1fr 1fr !important; padding: 0.5rem 1rem !important; min-height: 64px !important; }
        .site-title-overlay.header-logo { font-size: 1.9rem !important; }
      }
    </style>
    """
  end
