defmodule WebWeb.FitnessLive.Biometrics do
    ...
    entries =
      ...
      |> Enum.map(fn b ->
        %{
          ...
          calories_in: b.calories_in,
          protein_grams: b.protein_grams,
          fiber_grams: b.fiber_grams,
          body_fat_percentage: to_f(b.body_fat_percentage),
          water_oz: b.water_oz,
          soreness: b.soreness,
          energy: b.energy,
  ...
  defp load_with_scores do
    ...
    |> Enum.map(fn b -> Map.put(b, :score, Biometric.compute_score(b, goals)) end)
  end
        ...
        <.form for={@form} phx-change="validate" phx-submit="save" class="bio-form">
          ...
          <div class="bio-form-grid">
            <div class="bio-field">
              ...
              <.input
                field={@form[:calories_in]}
                type="number"
                placeholder={@goals[:calories_in]}
                class="bio-input"
              />
            </div>
            <div class="bio-field">
              ...
              <.input
                ...
                type="number"
                placeholder={@goals[:protein_grams]}
                class="bio-input"
              />
            </div>
            <div class="bio-field">
              <label>Fiber (g)</label>
              <.input
                field={@form[:fiber_grams]}
                type="number"
                placeholder={@goals[:fiber_grams]}
                class="bio-input"
              />
            </div>
            <div class="bio-field">
