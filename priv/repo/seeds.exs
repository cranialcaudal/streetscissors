...
Finish with 2 laps of very easy Elementary Backstroke or Water Walking to flush lactate and recover for tomorrow.",
  ...
  # --- NO FOCUS — FULL BODY (added for the Mon/Sat athletic-training routine) ---
  %{
    name: "Hex Flat-Side Deadlift",
    slug: "hex-flat-side-deadlift",
    description:
      "The flat/low-handle variant of the hex (trap) bar deadlift, pulled from the low handles rather than the high ones used for the quad-dominant version. The lower handle height increases the hip-hinge range and posterior-chain (hip/hamstring) demand while keeping the centered load pattern that spares the lower back relative to a straight bar. Set the hips back, brace the trunk hard, and drive the floor away, keeping the bar path vertical.",
    muscle_group: "Gluteal Complex",
    resources:
      "Distinct from the high-handle hexbar deadlift — more hip-hinge, more posterior chain.",
    settings: %{"weight" => "2x45 lbs"}
  },
  %{
    name: "Bulgarian Split Squat (Goblet)",
    slug: "bulgarian-split-squat",
    description:
      "Elevate the rear foot on a bench and squat on the front leg, holding a single kettlebell goblet-style at the chest (or a plate) rather than a dumbbell in each hand. The single front-loaded implement demands more anti-flexion core bracing than a dual-dumbbell version. Elevate the front foot slightly on a plate for more quad bias if training for climbing/pedaling power. Single-leg force production and hip stability — the closest gym analog to the pedal stroke.",
    muscle_group: "Quadriceps",
    resources:
      "Cycling-strength single-leg accessory; distinct from the dumbbell-at-sides variant.",
    settings: %{"weight" => "25 lbs"}
  },
  %{
    name: "Landmine Rotational Press",
    slug: "landmine-rotational-press",
    description:
      "One end of the barbell anchored in a landmine sleeve (or corner). Starting with the bar near the hip, drive from the rear hip and rotate the torso as you press the bar up and across the body, letting the press finish the rotation rather than muscling it with the arm. Trains hip-to-shoulder force transfer — the same kinetic chain used in a punch or a bat/racquet swing.",
    muscle_group: "Deltoids",
    resources:
      "Rotational-power landmine variant, distinct from the straight staggered-stance press.",
    settings: %{"weight" => "30 lbs"}
  },
  %{
    name: "Lateral Raises",
    slug: "lateral-raises",
    description:
      "Cable version of the lateral deltoid raise: set the pulley low, raise the handle out to the side leading with the elbow until the arm is roughly parallel to the floor. Cables keep tension on the delt through the bottom of the range where dumbbells go slack. Don't shrug the traps to assist, and lower under control.",
    muscle_group: "Deltoids",
    resources: "Cable variant — constant tension through the full range.",
    settings: %{"weight" => "10 lbs"}
  },
  %{
    ...
    description:
      "Seated, knees bent and feet elevated, holding a kettlebell at the chest. Rotate the torso side to side, tapping the bell down near the hip on each side, while flaring the extended legs outward and back in with each rep to add a leg-lever/hip-flexor component on top of the oblique rotation. Rotate from the torso, not just the arms, and keep the lower back from rounding.",
    muscle_group: "Abdominals",
    resources:
      "Adds a leg out-flare to the standard Russian twist for extra hip-flexor/core demand.",
    settings: %{"weight" => "25 lbs"}
  },
  %{
    name: "Bench Tricep Dips",
    slug: "bench-tricep-dips",
    description:
      "Hands on a bench behind you, legs extended out in front, feet on the floor or another bench. Lower the hips toward the floor by bending the elbows, then press back up to lock-out. Keep the shoulders down away from the ears throughout. Unlike parallel-bar dips, the fixed hand position and extended legs shift more of the load onto the triceps and put less demand on the chest/shoulders.",
    muscle_group: "Triceps Brachii",
    resources: "Bench-supported variant, distinct from parallel-bar dips.",
    settings: %{"result" => "3 x 12-15"}
  },
  %{
    name: "Face Pulls",
    slug: "face-pulls",
    description:
      "Cable set at upper-chest to head height with a rope attachment. Pull the rope toward the face, leading with the elbows high and pulling the hands apart at the end range to rotate the shoulders externally. Targets the rear delts, external rotators, and mid-traps — the muscles that decelerate a throw or a punch and that heavy pressing tends to neglect.",
    muscle_group: "Trapezius",
    resources: "Balances pressing volume; protects the rotator cuff for throwing/punching.",
    settings: %{"weight" => "20-30 lbs"}
  }
]
