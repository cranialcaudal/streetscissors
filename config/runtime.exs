...
if negatives_path = System.get_env("NEGATIVES_PATH") do
  config :web, :negatives_path, negatives_path
end

# The author's name for the structured data crawlers read. Kept out of the
# code; unset, no author is emitted.
if author_name = System.get_env("AUTHOR_NAME") do
...
if config_env() == :prod do
  ...
  # disabled when these are unset, and the Activities page shows what it has).
  config :web, :komoot,
